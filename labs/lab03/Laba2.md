...
1. Создайте учётную запись на https://github.com (На скриншоте мы уже создали нашу учетную запись)
   ![Учетная запись](pictures_lab02/Учетная%20запись%20Git.png)

2. Установка программного обеспечения
   ![Установка git-flow в Fedora Linux](/pictures_lab02/Установка%20программного%20обеспечения.png)
   Скриншот(устанавливаем git-flow в Fedora Linux)
&nbsp;
   ![Установка gh в fedora linux](pictures_lab02/устанавливаем%20GH.png)
...
![Базовая настройка GIT](pictures_lab02/Базовая%20настройка%20GIT.png)

4. Создаем ключи SSH
   ![Ключ с размером 4096 бит](pictures_lab02/Создание%20SSH%20ключа.png)
   Скриншот: Устанавливаем ключ по алгоритму rsa с ключем размером 4096 бит
На скриншоте выбрали все основные параметры ключа
   ![Алгоритм ключа ed25519](pictures_lab02/Установка%20SSH%20ключа%20ED25519.png)
   Скриншот: Ключ алгоритма ed25519
&nbsp;
   И добавляем ключ в гит хаб
   ![Добавление ключа SSH](pictures_lab02/Добавляем%20SSH%20ключ.png)

5. Создаем ключ PGP
   ![Создание ключа PGP](pictures_lab02/Создание%20PGP%20ключа.png)
   Скриншот:Выбрали все основные параметры ключа
&nbsp;
    Добавляем ключ в Гит Хаб
    ![Добавление ключа PGP в GitHub](pictures_lab02/Добавляем%20PGP%20ключ.png)

6. Создаем репозиторию курса на основе шаблона
   ![Создание репозитория](pictures_lab02/Создача%20репозитория.png)
   &nbsp;
   И смотри как получилось на GitHub
    ![репозиторий на GitHub](pictures_lab02/Репозиторий%20на%20GIT.png)
